...
public class Lolipop1 extends PlanetEntity{

	private static final String FILE1 = "PlanetEntities/Sweets/Lolipop1/Head";
	private static final String FILE2 = "PlanetEntities/Sweets/Lolipop1/Stil";
	private static final int NUMBER_OF_MODELS = 2;
	
	public Lolipop1(Planet planet,int instances) {
	...
	protected void setModels() {
		...
		Material materialStamm = new Material(new Vector3f(0.2f), new Vector3f(1), new Vector3f(0.1f,0.1f,0.1f), 100);
