...
public class Chocolate1 extends PlanetEntity{

	private static final String FILE = "PlanetEntities/Sweets/chocolate1";
	private static final int NUMBER_OF_MODELS = 1;
	
	public Chocolate1(Planet planet,int instances) {
