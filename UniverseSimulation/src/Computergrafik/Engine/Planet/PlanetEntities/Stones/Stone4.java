...
public class Stone4 extends PlanetEntity{

	private static final String FILE = "PlanetEntities/Stones/Stone4";
	private static final int NUMBER_OF_MODELS = 1;
	
	public Stone4(Planet planet,int instances) {
	...
	public void calculateColors() {	
		...
		for (int i = 0; i < colors.length; i+=3) { 
			...
			colors[i+1]=100f/255f*(colorOffset+((float)Math.random()*(1f-colorOffset)));
