...
public class FloatingParticle1 extends FloatingParticle {

	private static final String FILE = "PlanetParts/FloatingParticle1";
	private static final float SIZE = 0.03f;
	private static final int NUMBER_OF_MODELS = 1;
	
	public FloatingParticle1(Planet planet) {
