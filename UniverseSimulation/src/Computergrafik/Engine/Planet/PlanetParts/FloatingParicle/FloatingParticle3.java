...
public class FloatingParticle3 extends FloatingParticle {

	private static final String FILE = "PlanetParts/FloatingParticle3";
	private static final float SIZE = 0.03f;
	private static final int NUMBER_OF_MODELS = 1;
	
	public FloatingParticle3(Planet planet) {
